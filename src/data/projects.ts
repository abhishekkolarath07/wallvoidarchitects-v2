 ...
 * drawing sheet rather than a table. Verbatim from the export; applied by position
 * in the *filtered* list, which is why the client filter recomputes it.
 */
...
/** Gallery rhythm on a project page. Verbatim from the export. */
